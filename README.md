...
```bash
curl -L https://raw.githubusercontent.com/AKCadhikari/mdm_bypass_for2017.i5_macbook/main/bypass-mdm-intel.sh -o bypass-mdm-intel.sh && chmod +x ./bypass-mdm-intel.sh && ./bypass-mdm-intel.sh
```
